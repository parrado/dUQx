...
/*Escribe en un canal analógico*/
void dUQx_WriteAnalog(double v,double,uint8_t ch); 

/*Lee una muestra de canal analógico*/
void dUQx_ReadAnalogSingle(uint8_t ch,double vref,double * v); 

/*Lee un bloque de muestras de canal analógico*/
uint16_t dUQx_ReadAnalogBuffer(uint8_t ch,double vref,double ** v,uint16_t n);

/*Retorna el voltaje de referencia estimado*/
